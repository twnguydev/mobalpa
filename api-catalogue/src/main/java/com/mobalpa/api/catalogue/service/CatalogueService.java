...
import com.mobalpa.api.catalogue.repository.StoreRepository;
...
public class CatalogueService {
    ...
    public List<Product> getBestSellers() {
        ...
        List<String> bestSellingProductIds = productSalesCount.entrySet()
            .stream()
        ...
        return storeRepository.findProductsByIds(bestSellingProductIds);
    }
