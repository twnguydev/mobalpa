...
public class DeliveryService {
    ...
    public List<TrackingDetailsDTO> getTrackingDetails(UUID id) {
        ...
        String trackingUrl = API_POSTE_BASE_URL + "/?code=" + delivery.getDeliveryMethod() + "&apikey=" + "your_api_key";
    ...
    public List<DeliveryDTO> getDeliveryPrices() {
        return null;
    }
}
